...
@Component({
  selector: 'app-mavenqueries',
  templateUrl: './mavenqueries.component.html',
  styleUrls: ['./mavenqueries.component.css']
})
export class MavenqueriesComponent implements OnInit {
