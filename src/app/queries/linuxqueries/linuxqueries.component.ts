...
@Component({
  selector: 'app-linuxqueries',
  templateUrl: './linuxqueries.component.html',
  styleUrls: ['./linuxqueries.component.css']
})
export class LinuxqueriesComponent implements OnInit {
