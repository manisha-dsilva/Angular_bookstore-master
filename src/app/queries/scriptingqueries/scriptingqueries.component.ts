...
@Component({
  selector: 'app-scriptingqueries',
  templateUrl: './scriptingqueries.component.html',
  styleUrls: ['./scriptingqueries.component.css']
})
export class ScriptingqueriesComponent implements OnInit {
