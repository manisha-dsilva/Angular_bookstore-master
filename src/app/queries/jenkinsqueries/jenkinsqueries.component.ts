...
@Component({
  selector: 'app-jenkinsqueries',
  templateUrl: './jenkinsqueries.component.html',
  styleUrls: ['./jenkinsqueries.component.css']
})
export class JenkinsqueriesComponent implements OnInit {
