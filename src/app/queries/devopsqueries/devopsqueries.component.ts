...
@Component({
  selector: 'app-devopsqueries',
  templateUrl: './devopsqueries.component.html',
  styleUrls: ['./devopsqueries.component.css']
})
export class DevopsqueriesComponent implements OnInit {
