...
@Component({
  selector: 'app-jenkisvideo',
  templateUrl: './jenkinsvideo.component.html',
  styleUrls: ['./jenkinsvideo.component.css']
})
export class JenkinsvideoComponent implements OnInit {
