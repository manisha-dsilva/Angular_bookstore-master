...
@Component({
  selector: 'app-othersvideo',
  templateUrl: './othersvideo.component.html',
  styleUrls: ['./othersvideo.component.css']
})
export class OthersvideoComponent implements OnInit {
