...
@Component({
  selector: 'app-javavideo',
  templateUrl: './javavideo.component.html',
  styleUrls: ['./javavideo.component.css']
})
export class JavavideoComponent implements OnInit {
