...
@Component({
  selector: 'app-scriptingvideo',
  templateUrl: './scriptingvideo.component.html',
  styleUrls: ['./scriptingvideo.component.css']
})
export class ScriptingvideoComponent implements OnInit {
...
getVideos() : void {
  ...
  this.videoService
  .getVideossByCategory("Scripting")
  .subscribe((data:any) => {
    console.log(data);
    this.videos = data;
  });
